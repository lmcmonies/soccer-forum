...
module.exports = {
    ...
    asyncErrorHandler: (fn) =>
        ...
        if(req.isAuthenticated() && req.user.subscription === "Paid" || req.user.isAdmin){
          return next();
        }
        ...
        hasPaid: async (req,res,next) =>{
            if((req.isAuthenticated() && req.user.subscription === "Paid" 
            && req.user.hasPaid === true) || (req.isAuthenticated() 
            && req.user.subscription === "Free" && req.user.hasPaid === false)
